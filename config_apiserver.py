...
def config_api_server(app, mode) :
    ...
    app.add_url_rule('/api/v1/company_status_request', view_func=web_oauth.company_status_request, methods = ['GET', 'POST'], defaults={'mode' : mode})
    app.add_url_rule('/api/v1/issue_reference_on_behalf', view_func=web_oauth.oauth_issue_reference_on_behalf, methods = ['GET', 'POST'], defaults={'mode' : mode})
