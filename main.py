...
app.add_url_rule('/user/request_certificate/',  view_func=web_main.request_certificate, methods = ['GET','POST'], defaults={'mode' : mode})
...
app.add_url_rule('/user/add_manager/',  view_func=web_main.add_manager, methods = ['GET','POST'], defaults={'mode' : mode})
...
#app.add_url_rule('/did/',  view_func=web_main.did_check, methods = ['GET','POST'], defaults={'mode' : mode})
