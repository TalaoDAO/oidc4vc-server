...
from signaturesuite import jws
...
def sign(jld_document, private_key):
    ...
    jws_signature = jws.sign_jws(normalized_jld_hash, private_key)
    ...
    jld_document.update({"proof": proof})
...
def verify(signed_jld_document, public_key):
    ...
    return jws.verify_jws(normalized_jld_hash, jws_signature, public_key)
