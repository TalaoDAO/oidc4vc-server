	...
	if "ProfessionalExperienceAssessment" in session['displayed_certificate']['type'] :
		...
		return render_template('./certificate/professionalexperienceassessment_vc.html',
							**menu,
							...
							companyName=session['displayed_certificate']['credentialSubject']['issuedBy']['name'],
							badge=my_badge,
							title = session['displayed_certificate']['credentialSubject']['title'],
							familyName=session['displayed_certificate']['credentialSubject']['familyName'],
							givenName=session['displayed_certificate']['credentialSubject']['givenName'],
							description=session['displayed_certificate']['credentialSubject']['description'],
							start_date=session['displayed_certificate']['credentialSubject']['startDate'][:10],
							end_date=session['displayed_certificate']['credentialSubject']['endDate'][:10],
							...
							logo=session['displayed_certificate']['credentialSubject']['issuedBy']['logo'],
